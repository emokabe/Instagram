...
1. Creating a backend database from scratch
2. When/when not to use segue

## Video Walkthrough

Here's a walkthrough of implemented user stories:

https://submissions.us-east-1.linodeobjects.com/metau_ios/rqIpeBbV.gif

GIF automatically created through Codepath.
